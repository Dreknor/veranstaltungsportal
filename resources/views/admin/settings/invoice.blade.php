<x-layouts.app>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">
                    <i class="fas fa-file-invoice mr-2"></i>Rechnungsnummern-Einstellungen
                </h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">
                    Konfigurieren Sie das Format und die Nummerierung für Rechnungen von Buchungen und Plattformgebühren.
                </p>
            </div>
                ...
                <form action="{{ route('admin.settings.invoice.update') }}" method="POST" class="p-6">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center border-b pb-2">
                            ...
                            Buchungs-Rechnungen (für Teilnehmer)
                        </h3>
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center border-b pb-2">
                            ...
                            Plattformgebühren-Rechnungen (für Veranstalter)
                        </h3>
    ...
    <script>
        ...
        function updatePreview(type) {
            const formatInput = document.getElementById(`invoice_number_format_${type}`);
            const paddingInput = document.getElementById('invoice_number_padding');
            const previewSpan = document.getElementById(`preview-${type === 'booking' ? 'booking' : 'platform'}`);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            updatePreview('booking');
            updatePreview('platform_fee');

            ['invoice_number_format_booking', 'invoice_number_padding'].forEach(id => {
                document.getElementById(id).addEventListener('input', () => updatePreview('booking'));
            });

            ['invoice_number_format_platform_fee', 'invoice_number_padding'].forEach(id => {
                document.getElementById(id).addEventListener('input', () => updatePreview('platform_fee'));
            });
        });
    </script>
    @endpush
