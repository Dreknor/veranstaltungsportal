<x-layouts.app title="Plattform-Rechnungsdaten">
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Plattform-Rechnungsdaten</h1>
                <p class="text-gray-600 mt-2">Firmendaten für Rechnungen an Organisatoren</p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <form method="POST" action="{{ route('admin.monetization.billing-data.update') }}">
                    @csrf
                    @method('PUT')

                    <div class="space-y-6">
                        <div>
                            <label for="company_name" class="block text-sm font-medium text-gray-700">Firmenname *</label>
                            <input type="text" name="company_name" id="company_name" required
                                   value="{{ old('company_name', $billingData['company_name'] ?? '') }}"
                                   placeholder="Ihre Plattform GmbH"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="email" name="company_email" id="company_email" required
                                       ...
                                       placeholder="info@ihre-plattform.de"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                @error('company_email')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="bank_name" id="bank_name" required
                                           value="{{ old('bank_name', $billingData['bank_name'] ?? '') }}"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="bank_iban" id="bank_iban" required
                                               value="{{ old('bank_iban', $billingData['bank_iban'] ?? '') }}"
                                    ...
                                    <div>
                                        <label for="bank_bic" class="block text-sm font-medium text-gray-700">BIC/SWIFT *</label>
                                        <input type="text" name="bank_bic" id="bank_bic" required
                                               value="{{ old('bank_bic', $billingData['bank_bic'] ?? '') }}"
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p>Diese Daten werden als Absender auf allen Plattformgebühr-Rechnungen an Organisatoren angezeigt. Die Bankverbindung ist für die Zahlung der Gebühren erforderlich.</p>
                        </div>
                    </div>
                </div>
            </div>
