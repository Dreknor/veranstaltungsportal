@php
    $page = \App\Models\LegalPage::getByType('impressum');
@endphp
    ...
    <div class="min-h-screen bg-gray-50 py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm p-8 lg:p-12">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ $page?->title ?? 'Impressum' }}</h1>
                ...
                <div class="prose prose-gray max-w-none">
                    @if($page?->content)
                        {!! $page->content !!}
                    @else
                        <p class="text-gray-500">Das Impressum wird gerade bearbeitet. Bitte schauen Sie später wieder vorbei.</p>
                    @endif
                </div>
