                                    ...
                                    <a href="{{ route('help.article', ['category' => $result['category'], 'article' => $result['slug']]) }}"
                                       class="block p-4 border dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow">
                                        <div class="flex items-start justify-between mb-2">
                                            <h4 class="font-semibold text-lg text-gray-900 dark:text-gray-100 flex-1">
                                                {{ $result['title'] }}
                                            </h4>
                                            @if($result['category'] === 'organizer')
                                                <span class="ml-2 px-2 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-medium rounded">
                                                    Veranstalter
                                                </span>
                                            @else
                                                <span class="ml-2 px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-medium rounded">
                                                    Nutzer
                                                </span>
                                            @endif
                                        </div>
