    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        ...
        <form action="{{ route('organizer.settings.invoice.update') }}" method="POST">
            ...
            <div class="flex justify-between items-center pt-6 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route('organizer.settings.invoice.sample') }}"
                   class="inline-flex items-center gap-2 px-6 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-100 font-medium rounded-lg transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
