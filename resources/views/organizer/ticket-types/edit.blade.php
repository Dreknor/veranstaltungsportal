<x-layouts.app title="Ticket-Typ bearbeiten">
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                ...
                <h1 class="text-2xl font-bold text-gray-900 mt-4">Ticket-Typ bearbeiten</h1>
                <p class="text-gray-600 mt-1">{{ $ticketType->name }}</p>
            </div>
