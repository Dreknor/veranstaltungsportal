    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-lg w-full text-center">
            ...
            <p class="text-lg text-gray-600 mb-8">
                Wir führen gerade Wartungsarbeiten durch. Das Bildungsportal ist vorübergehend nicht verfügbar. Bitte versuchen Sie es in Kürze erneut.
            </p>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
                ...
                <p class="text-blue-700">
                    Wir arbeiten daran, das Portal schnellstmöglich wieder verfügbar zu machen.
                </p>
            </div>

            <button onclick="window.location.reload()" class="inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition">
                Erneut versuchen
            </button>
        </div>
    </div>
