    ...
    @foreach($tickets as $index => $ticketData)
        <div class="container">
            ...
            <div class="qr-section">
                ...
                <div class="ticket-reference">{{ $ticketData['item']->ticket_number }}</div>

                 @if($event->show_qr_code_on_ticket && isset($ticketData['qrCode']))
                    <div class="qr-code">
            ...
            <div class="attendee-highlight">
                ...
                <div class="attendee-name">{{ $ticketData['item']->attendee_name ?? $booking->customer_name }}</div>
                @if($ticketData['item']->attendee_email)
                    <div style="color: #4b5563; font-size: 12px;">{{ $ticketData['item']->attendee_email }}</div>
                @endif
            </div>
...
hy                    @if($event->isOnline())
            ...
            <!-- Ticket Type -->
            <div class="section">
                <div class="section-title">Ticket-Typ</div>
                <div class="info-grid">
                    <div class="info-row">
                        <div class="info-label">Kategorie:</div>
                        <div class="info-value">{{ $ticketData['item']->ticketType->name }}</div>
                    </div>
                    <div class="info-row">
            ...
            <!-- Footer -->
            <div class="footer">
                <p>Ticket {{ $index + 1 }} von {{ count($tickets) }} | Buchung: {{ $booking->booking_number }}</p>
