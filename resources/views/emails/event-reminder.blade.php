...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; border-radius: 10px 10px 0 0; text-align: center;">
        ...
        @endif
        <h1 style="margin: 0; font-size: 28px;">⏰ Veranstaltungserinnerung</h1>
        <p style="margin: 10px 0 0 0; font-size: 16px; opacity: 0.9;">Ihre Veranstaltung beginnt bald!</p>
    </div>
    ...
    <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb; border-top: none;">
        ...
        <p style="font-size: 16px;">
            Dies ist eine freundliche Erinnerung, dass Ihre gebuchte Veranstaltung
        ...
        <div style="margin: 20px 0;">
            <h3 style="color: #374151; font-size: 16px; margin-bottom: 10px;">Veranstaltungsbeschreibung:</h3>
        ...
        <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center;">
            <p style="font-size: 12px; color: #9ca3af; margin: 5px 0;">
                Sie erhalten diese E-Mail, weil Sie eine Veranstaltung gebucht haben.
            </p>
            <p style="font-size: 12px; color: #9ca3af; margin: 5px 0;">
