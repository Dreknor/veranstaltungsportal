                ...
                <div class="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-700 last:border-b-0">
                    <div class="flex items-start">
                        <div class="flex-shrink-0 mr-3">
                            <!-- Icon basierend auf Notification-Typ -->
                            ...
                            <template x-if="notification.type.includes('Booking')">
                            ...
                            <template x-if="notification.type.includes('Event') && !notification.type.includes('Booking')">
                            ...
                            <template x-if="notification.type.includes('Badge')">
                            ...
                            <template x-if="notification.type.includes('Connection')">
                            ...
                            <!-- Fallback Icon -->
                            <template x-if="!notification.type.includes('Critical') && !notification.type.includes('Booking') && !notification.type.includes('Event') && !notification.type.includes('Badge') && !notification.type.includes('Connection')">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 dark:text-gray-100" x-text="notification.data.title || 'Benachrichtigung'">
                            </p>
                            <p class="text-xs text-gray-600 dark:text-gray-300 mt-1 line-clamp-2" x-text="notification.data.message || 'Keine Details verfügbar'">
                            </p>
