    ...
    public function generateSampleInvoice(Organization $organization, string $invoiceNumber): string
    {
        ...
        $sampleZugferdData = [
            ...
            'seller' => [
                ...
                'email'        => $billingData['company_email'] ?? ($organization->email ?? null),
                'phone'        => $billingData['company_phone'] ?? ($organization->phone ?? null),
                'contact_name' => $billingData['company_name'] ?? $organization->name,
            ],
            'buyer' => [
